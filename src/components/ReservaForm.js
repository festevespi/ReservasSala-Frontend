...
function ReservaForm() {
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      setErros(['Erro ao inserir reserva']);
    }
  };
    ...
    <div className="container mt-4">
      ...
      <form className="row g-3" onSubmit={handleSubmit}>
        ...
        <div className="col-md-6">
          ...
          <input className="form-control" type="text" name="responsavel" value={form.responsavel} onChange={handleChange} required />
        </div>
        <div className="col-md-6">
          ...
          {form.cafe && (
            <input className="form-control mt-2" type="number" name="quantidadePessoas" value={form.quantidadePessoas} onChange={handleChange} placeholder="Quantidade de pessoas" min="1" />
          )}
        </div>
